...
(function($) {
	...
	$.fn.graphup.painters.bubbles = function($cell, o) {
		...
		$cell.html(
			'<div style="position:relative; padding:' + $cell.css('padding-top') + ' ' + $cell.css('padding-right') + ' ' + $cell.css('padding-bottom') + ' ' + $cell.css('padding-left') + '; height:' + $cell.height() + 'px;">' +
				'<div class="' + o.classBubble + '" style="position:absolute; top:' + ($cell.innerHeight() / 2 - percent / 100 * diameter / 2) + 'px; left:' + ($cell.innerWidth() / 2 - percent / 100 * diameter / 2) + 'px; width:' + percent / 100 * diameter + 'px; height:' + percent / 100 * diameter + 'px; background:rgb(' + color + '); opacity:0.75; z-index:' + Math.round(percent) + '; border-radius:999px; -moz-border-radius:999px; -webkit-border-radius:999px;"></div>' +
